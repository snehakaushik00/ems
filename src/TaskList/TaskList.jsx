  ...
  return (
    <div id='tasklist'className='h-[55%] overflow-x-auto flex items-center justify-start gap-5 flex-nowrap w-full py-5  mt-10'>
      <div className='flex-shrink-0 h-full w-[350px] p-5 bg-red-400 rounded-xl'>
          ...
          <p className='text-sm mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus, sint. Ducimus unde officia nam adipisci, nihil dignissimos, temporibus et provident modi quidem, impedit soluta itaque delectus aliquid ea laborum reprehenderit.</p>
      </div>
